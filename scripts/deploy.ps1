[string]$version = gc version
[string]$chart_ref = "music-stream-ui"
...
docker build -f ./docker/Dockerfile -t "192.168.68.108:5000/music-stream-ui:$version" .
if (-Not $?) {
    echo "Error building docker image"
    Exit
}

docker push "192.168.68.108:5000/music-stream-ui:$version"
if (-Not $?) {
